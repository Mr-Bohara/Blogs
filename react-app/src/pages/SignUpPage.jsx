        ...
        <div className="perspective-1000 w-full max-w-md">
          <div className="preserve-3d card-3d-effect bg-white/80 backdrop-blur-2xl p-10 rounded-[2.5rem] shadow-[0_50px_100px_-20px_rgba(0,32,26,0.15),0_30px_60px_-30px_rgba(0,0,0,0.2)] border border-white/50 relative">
            ...
            <div className="space-y-2 mb-8">
              <h3 className="text-2xl font-bold text-emerald-950 tracking-tight">Create your space</h3>
              <p className="text-emerald-800/60 text-sm">Start your curation journey with us.</p>
            </div>
            <form className="space-y-5">
            <div className="space-y-2">
                <label className="block text-[11px] font-bold text-emerald-900/40 uppercase tracking-widest px-1">Full Name</label>
                <div className="relative">
                  <input className="w-full bg-emerald-50/50 border-0 rounded-2xl px-5 py-4 text-emerald-900 placeholder:text-emerald-900/30 focus:ring-2 focus:ring-emerald-500/20 inner-shadow-soft transition-all duration-300 font-medium" placeholder="Your Name" type="text" />
                </div>
              </div>
              <div className="space-y-2">
            ...
            <div className="mt-10 text-center">
              <p className="text-emerald-800/50 text-xs font-medium">
                ...
                <a className="text-emerald-700 font-bold hover:underline underline-offset-4" href="/login">Sign In</a>
              </p>
            </div>
          </div>
        </div>
